...
// Representa um raio laser (usado pelo LaserBoss da Fase 6 e pelo AncientGodBoss da Fase 10).
// Primeiro pisca um "aviso" sem causar dano (tempo pro jogador se esquivar),
